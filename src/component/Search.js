...
const Search = () => {
  return (
    <section className="bg-[('/src/component/img/pexels-markus-spiske-2004161.jpg')] text-gray-600 body-font">
  <div className="container px-8 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-8xl text-2xl font-medium title-font mb-4 text-gray-900">Fastest internet provider in country.
      <br className="hidden lg:inline-block"/>we're still growing</h1>
