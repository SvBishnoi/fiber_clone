...
<div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-xl text-bold text-gray-900 dark:text-gray-900 sm:text-center">Follow Us
        </span>
        <div className="flex mt-4 bg-grey-100 space-x-6 sm:justify-center md:mt-0">
    ...
    <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Check Availibity</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <a href="#" className=" hover:underline">Residensial services</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Small business</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Property managers</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Google Fiber cities</a>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Learn More</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <a href="#" className="hover:underline">Internet</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Wi-Fi tech</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Streaming TV</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Home phone</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Gaming</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Work from home</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Distance learning</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                ...
                <li className="mb-4">
                    <a href="#" className="hover:underline">Help Community</a>
                </li>
                <li className="mb-4">
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                ...
                <li className="mb-4">
                    <a href="#" className="hover:underline">Community Impact</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">DEIB</a>
                </li>
            </ul>
        </div>
    </div>
